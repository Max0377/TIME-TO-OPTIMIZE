...
if (openAcessibilidade && floatAcessibilidade && closeAcessibilidade) {
...
if (btnCMD) btnCMD.addEventListener("click", () => { window.location.href = "cmd.html"; });
if (btnPowerShell) btnPowerShell.addEventListener("click", () => { window.location.href = "Comandos do powershell.html"; });
if (btnWinR) btnWinR.addEventListener("click", () => { window.location.href = "winr.html"; });
