...
/* ===== Efeito Digitação ===== */
if (mainTitle) {
  const texto = "Bem-vindo à TIME TO OPTIMIZE";
  let idx = 0;
  function typeWriter() {
    if (idx < texto.length) {
...
if (btnCMD) btnCMD.addEventListener("click", () => { window.location.href = "https://max0377.github.io/TIME-TO-OPTIMIZE/windows/cmd.html"; });
